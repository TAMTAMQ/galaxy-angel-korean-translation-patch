...
REVIEWED_OVERRIDES = {
    ...
    0x224A78: "바스켓에 넣을 때는",
    0x224AA0: "바스켓 앞에서 ○ 버튼을 눌러 주세요",
    0x224AC8: ".",
    0x224AE0: "좌우 이동은 방향키 좌우로 하",
    0x224B08: "면 됩니다.",
    0x224B80: "하지만 샌드위치를 많이 올린",
    0x224BA8: "상태일 때는 당황하지 마세",
    0x224BD0: "요! 떨어뜨리면 큰일이니까요～!",
    0x224C08: "그리고 저, 가끔",
    0x224C30: "씩 요리 중에 재료를 떨어뜨릴 때",
    0x224C58: "가 있답니다…….",
    0x224C80: "제가 떨어뜨린 재료가 굴러오",
    0x224CA8: "면 방향키 위를 눌러서",
    0x224D00: "점프할 때 샌드위치",
    0x224D28: "를 많이 올렸다면 꼭",
    0x224D80: "그러지 않으면 샌드위치를",
    0x224E60: "꺄～! 토, 토마토가 굴러가 버",
    0x224EF8: "꺄아, 양, 양상추가 굴러가",
    0x224F30: "택트 씨, 정말 고마워",
    0x224F58: "요!",
    0x224F98: "아앗, 큰일이야! 시간 없어～!",
    0x224FB8: "나, 이런 거 별로 익숙하지 않",
    0x224FE0: "아서 말이야…….",
    0x2260E8: "공격은 방향키와 조합",
    0x226110: "해 여러 기술을 쓸 수 있어.",
    0x226140: "자기가 보는 쪽의 방향",
    0x226158: "키와 ○ 버튼을 누르면",
    0x226250: "……뭐, 이런 느낌이야.",
    0x226270: "당연히 나도 여러 기술을",
    0x226298: "쓰니까 각오해 둬.",
    0x226300: "시합은 포인트제야. 기술을 맞혀.",
    0x226460: "잘 들어 두라고.",
    0x227A08: "그럼 놀이 방법을 설명드릴게",
    0x227A30: "요.",
    0x227AA8: "『선』이 되고",
    0x227B48: "먼저 선이 카드를 1장 뽑고,",
    0x227B70: "필요 없는 카드는 버립니다. 그 후엔,",
    0x227C30: "하고 ○ 버튼으로 버릴 수 있습니다.",
    0x227C60: "족보가 완성되면 『올라가기』",
    0x227D78: "모으면 완성돼요.",
    0x228308: "저희 엔젤대와의 승부예요.",
    0x2285B0: "좋아, 나도 상대해 줄게",
    0x228700: "너, 별거 없네.",
    0x228730: "앗싸! 완성이다～!",
    0x228770: "점점 감이 오는데!",
    0x2287D8: "우와～ 정말 잘 완성하셨네",
    0x228800: "요～.",
    0x228860: "훌륭하군요.",
    0x228910: "오늘은 컨디션이 별로네.",
    0x2289C8: "너! 레이디한테 좀 더 상냥하",
    0x2289F0: "게 굴어!",
    0x228A78: "드는 엉망이었어요…….",
    0x228CC0: "잠깐, 뭐야～? 전혀 아니",
    0x228CE8: "잖아!",
    0x228F60: "다음에도 한판 부탁드려요★",
    0x229148: "사령관님, 설마 날 이긴다고?",
    0x229168: "난 강하다고.",
    0x229270: "덤벼 봐.",
    0x229398: "어머! 저희 모두에게 이기셨군",
    0x2293C0: "요! 택트 씨는 정말 못 당하",
    0x2293E8: "겠네요★",
    0x229B28: "이번 게임의 도라 카드와 같은 카드입니다",
    0x22A1E0: "「센베이」「초다시마」「오야츠카츠」「라면과자」",
    0x22A218: "「후가시」「초오징어」「비스킷」",
    0x22A240: "빨강・파랑・노랑 3색 카드입니다. 각 색은",
    0x22A338: "만능 카드입니다. 어떤 카드로도 대신할 수",
    0x22A370: "있습니다.",
    0x22A3E8: "조건이 되면 △ 버튼으로 리치를 선언할 수",
    0x22A650: "상대가 버린 카드로 완성한 경우입니다",
    0x22A688: "론과 퐁이 모두 가능하면 Ｌ１, Ｒ１ 버튼,",
    0x22A6C0: "덱에서 직접 뽑은 패로 완성한 경우입니다",
    0x22AB88: "스테이지 끝에는 중간 보스 몬스터",
    0x22ABB0: "가 1마리 나와. 쓰러뜨리면",
    0x22ADD0: "서로 도울 때도 필요하",
    0x22ADF0: "니까 말이야.",
    0x22B148: "걸리긴 하지만.",
    0x22B2D8: "그럼, 바로 총을 고르렴",
    0x22B300: ".",
    0x22B3A8: "훈련하다 보면 분명 늘 거야.",
    0x22B3D0: "언제든 다시 오렴.",
    0x22D3C8: "위　　력",
    0x22E640: "이걸로 좌우 시점을 움직여.",
    0x22E710: "응, 잡는 법은 이 정도였",
    0x22E738: "던가.",
    0x2306D8: "어떻게 할까……",
    0x2306F0: "한번 쭉 알려줄래?",
    0x2308B0: "니다.",
    0x230A98: "상대에게 잘 던진 것이",
    0x230AC0: "됩니다.",
    0x230BD8: "잘 들으시고, 저희가",
    0x230C58: "상대가 플라잉 디스크를",
    0x230C80: "던지면 캐치 포인트가",
    0x230CA8: "표시됩니다.",
    0x230D20: "이때 거리와 높이를 잘 보고",
    0x230D48: "잘 받아 주세요.",
    0x230D68: "물론 캐치하지 못해 바닥에",
    0x230D90: "떨어지면 실패랍니다.",
    0x230DD0: "특수한 궤도로 날기도 한다고",
    0x230E90: "내가 하나 조언해 둘",
    0x230EB8: "까.",
    0x230F40: "한테 차례를 넘겨주는",
    0x230F68: "식이지.",
    0x231018: "원한다면 다시 한번 설명해 줄 수도",
    0x231040: "있어.",
    0x231120: "마침 여러분도 다 모이셨네",
    0x231148: "요.",
    0x231220: "택트 씨가 엔젤대에게,",
    0x231240: "엔젤대가 택트 씨에게 잘",
}
